...
<div class='d-flex justify-content-between align-items-center mb-3'>
  <h3>No Serial Items Maintenance</h3>
</div>
      ...
      <table class='table table-hover datatable'>
        ...
        <tbody>
          <?php while ($r = $res->fetch_assoc()): ?><tr>
              ...
              <td><?= e($r['stock'] ?? 0) ?></td>
              <td><?php if ($r['item_id']): ?><a class='btn btn-sm btn-outline-info' href='view_item.php?id=<?= $r['item_id'] ?>'>View</a><?php endif; ?></td>
            </tr><?php endwhile; ?>
        </tbody>
      </table>
    </div>
