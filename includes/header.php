...
<div class='app'><nav class='topnav'>
  <div class='topnav-inner'>
    <div class='brand'>IT Asset<br><span>Management</span></div>
    ...
    <a class='navlink text-danger' href='logout.php'>Logout</a>
    <div class='topnav-user'><b><?= e($_SESSION['name']) ?></b><small class='text-muted ms-2'><?= e(strtoupper($_SESSION['role'])) ?></small></div>
  </div>
</nav>
<main class='content'>
