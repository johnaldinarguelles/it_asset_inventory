...
<div class='alert alert-info'>Use the <b>View</b> button to see all receiving, issuance, and return activities for a specific item. For non-unique items such as mouse and office supplies, use one general barcode/item code in the inventory master. Example: all mouse transactions use <b>5718185</b>, and stock is computed from Received + Returned - Issued.</div><div class='d-flex justify-content-between mb-3'><h3>Items & Real-time Stock</h3><div class='page-actions'><?php if(is_admin()): ?><a class='btn btn-success' href='export_excel.php?type=items'>Excel Export</a> <button class='btn btn-primary' onclick='openItemModal()'>+ Add Item</button><?php endif; ?></div></div>
